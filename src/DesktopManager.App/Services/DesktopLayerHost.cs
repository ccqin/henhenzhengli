...
{
    public static void AttachToDesktop(long childHwnd, int monX, int monY, int monW, int monH, bool iconLayer = false, bool keepSize = false)
    {
        WindowInterop.AttachTopLevel(new IntPtr(childHwnd), monX, monY, monW, monH, iconLayer, keepSize);
    }
